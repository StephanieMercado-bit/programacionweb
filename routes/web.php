...
// Rutas exclusivas para el cocinero
Route::middleware(['auth', 'cocinero'])->group(function () {
    Route::get('/cocina', App\Http\Livewire\CocinaPanel::class)->name('cocina.index');
});
...
Route::get('/perfil/historial-pedidos', App\Http\Livewire\HistorialPedidos::class)->name('historial')->middleware('auth');
