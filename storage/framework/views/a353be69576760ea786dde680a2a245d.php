...
<body>
    <header>
        <nav class="navbar">
            ...
            <?php if(Auth::check() && Auth::user()->cliente): ?>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <div class="perfil"><a href="/perfil"><?php echo e(Auth::user()->name); ?></a></div>
                    </li>
                </ul>    
            ...
            <?php elseif(Auth::check() && Auth::user()->admin): ?>
                <ul class="navbar-nav">
                    <li class="nav-item">
...
</head><?php /**PATH C:\Users\estre\Downloads\PW_Restaurante_Laravel\resources\views/layouts/header.blade.php ENDPATH**/ ?>